...
class BarcodeView extends React.Component {
  ...
  _animateLoop = () => {
    const {animatedLineOrientation, lineAnimationDuration, useNativeDriver} =
      this.props;
  ...
  _renderEdge = edgePosition => {
    const {edgeWidth, edgeHeight, edgeColor, edgeBorderWidth, edgeRadius} =
      this.props;
...
BarcodeView.propTypes = propTypes;
BarcodeView.defaultProps = defaultProps;
